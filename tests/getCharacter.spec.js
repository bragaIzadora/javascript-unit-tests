...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  ...
  it('Verifica se a função retorna o objeto correto para o parametro chamado', () => {
  ...
  it('Verifica se a função retorna o objeto correto para o parametro Brienne', () => {
  ...
  it('Verifica se a função retorna o objeto correto para o parametro Melissandre', () => {
  ...
  it('Verifica se o parametro não é case sensitive', () => {
    ...
    const lowCase = getCharacter('arya');
    expect(upperCase).toEqual(lowCase);
  });
  it('verifica se ao passar um nome que não tem na tabela retorna undefined', () => {
